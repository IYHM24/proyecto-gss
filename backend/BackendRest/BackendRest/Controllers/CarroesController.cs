...
namespace BackendRest.Controllers
{
    ...
    public class CarroesController : ControllerBase
    {
        ...
        public CarroesController(BackendRestContext context)
        {
            _context = context;
        }
        ...
        public async Task<ActionResult<Carro>> PostCarro(Carro carro)
        {
          if (_context.Carro == null)
          {
              return Problem("Entity set 'BackendRestContext.Carro'  is null.");
          }
            _context.Carro.Add(carro);
            await _context.SaveChangesAsync();

            return CreatedAtAction("GetCarro", new { id = carro.id_carro }, carro);
        }
        ...
        {
            return (_context.Carro?.Any(e => e.id_carro == id)).GetValueOrDefault();
        }
    }
}
